...
logging.basicConfig(level=logging.INFO, filename='bugorder.log', filemode='a',
...
class YsDing():
    ...
    def pay_data(self, tuple, pay_type):
        data = {
            ...
            "pre_balance_param_": {"pay_type_": pay_type, "pay_money_": tuple[2], "order_id_": tuple[0],
                                   "order_mod_time_": tuple[1]}
        }
        return data
